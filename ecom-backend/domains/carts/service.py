...
class CartService:
    ...
    def _prepare_cart_items(self, cart_input_data: CartUpdate | CartCreate,  mode: Literal["create", "update"], cart_id: int | None = None) -> list[CartItemDB]:
    ...
    def create(self, cart_create_data: CartCreate, user_id: int) -> CartData:
        cart_items_db_prep_result = self._prepare_cart_items(cart_create_data, mode="create")
    ...
    def update(self, cart_update_data: CartUpdate, cart_id: int) -> CartData:
        ...
        cart_db = self.repo.get(cart_id)
        cart_items_db_prep_result = self._prepare_cart_items(cart_update_data, mode="update", cart_id=cart_id)
